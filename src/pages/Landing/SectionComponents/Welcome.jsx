...
export default function Welcome() {
  return (
    <div className=" bg-brand-bg-light md:w-[680px] max-[613px]:w-full min-[613px]:w-fit md:rounded-3xl xsm:rounded-lg  md:mt-[40px]">
      <div className="flex flex-wrap min-[613px]:flex-col sm:justify-between sm:items-center max-sm:flex-wrap md:gap-[60px] xsm:gap-[20px] box-content p-[40px] max-sm:p-[20px]">
        <div>
        ...
        <div className="flex sm:flex-col min-[613px]:flex-row min-[613px]:items-center sm:items-start gap-[40px] xsm:gap-[20px] xsm:text-[10px] min-[320px]:text-[14px] items-center ">
          <button className="xsm:w-fit xsm:px-[10px] xms:py-[5px] xsm:py-[5px] xsm:rounded h-fit w-fit relative px-[20px] py-[10px] flex items-center gap-[10px] bg-gradient-to-br from-black border-[1px] border-brand-purple  to-brand-purple rounded-full">
            ...
            <img
              src={smile}
              className="md:w-[30px] md:h-[30px] xsm:w-[15px] xsm:h-[15px] sm:w-[20px] sm:h-[20px]"
              alt=""
            />
