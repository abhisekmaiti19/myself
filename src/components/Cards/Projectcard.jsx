...
export default function Projectcard({ name, img, desc }) {
  ...
  return (
    <div
      key={id}
      className=" max-sm:w-full w-[30rem] h-[30rem] bg-brand-bg border-[1px] border-black rounded-xl relative flex flex-col gap-[2rem] overflow-hidden  transition-all duration-300 ease-in-out"
    >
      {/* only for image  */}
      <div
